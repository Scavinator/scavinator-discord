...
GRANT UPDATE (discord_thread_id, discord_message_id, updated_at, page_number) ON TABLE items TO scavinator_rb_discord;
...
GRANT INSERT ON TABLE team_scav_hunts TO scavinator_rb_discord;
GRANT INSERT, SELECT ON TABLE teams TO scavinator_rb_discord;
GRANT USAGE ON SEQUENCE teams_id_seq TO scavinator_rb_discord;
GRANT INSERT, SELECT ON TABLE team_integrations TO scavinator_rb_discord;
GRANT USAGE ON SEQUENCE team_integrations_id_seq TO scavinator_rb_discord;
GRANT USAGE ON SEQUENCE team_scav_hunts_id_seq TO scavinator_rb_discord;
GRANT SELECT ON TABLE scav_hunts TO scavinator_rb_discord;
